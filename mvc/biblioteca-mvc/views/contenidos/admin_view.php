...
<div class="container-fluid">
 <div class="panel panel-info">
  ...
  <div class="panel-body">
   <form action="<?php echo RUTA_URL ?>ajax/administradorAjax.php" class="FormularioAjax" method="POST" data-form="save" autocomplete="off">
       <fieldset>
        ...
        <div class="container-fluid">
         <div class="row">
          <div class="col-xs-12">
           ...
           <input pattern="[0-9-]{1,30}" class="form-control" type="text" name="txt_cedula" required="" maxlength="30">
        </div>
          </div>
          <div class="col-xs-12 col-sm-6">
           <div class="form-group label-floating">
           <label class="control-label">Nombres *</label>
           <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="txt_nombre" required="" maxlength="30">
        </div>
          </div>
          <div class="col-xs-12 col-sm-6">
        <div class="form-group label-floating">
           <label class="control-label">Apellidos *</label>
           <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="txt_apellido" required="" maxlength="30">
        </div>
          </div>
          <div class="col-xs-12 col-sm-6">
        <div class="form-group label-floating">
           <label class="control-label">Teléfono</label>
           <input pattern="[0-9+]{1,15}" class="form-control" type="text" name="txt_telefono" maxlength="15">
        </div>
          </div>
          <div class="col-xs-12">
        <div class="form-group label-floating">
           <label class="control-label">Dirección</label>
           <textarea name="txt_direccion" class="form-control" rows="2" maxlength="100"></textarea>
        </div>
          </div>
         </div>
        </div>
       ...
       <fieldset>
        ...
        <div class="container-fluid">
         <div class="row">
          <div class="col-xs-12">
           ...
           <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,15}" class="form-control" type="text" name="txt_usuario" required="" maxlength="15">
        </div>
          </div>
          <div class="col-xs-12 col-sm-6">
        <div class="form-group label-floating">
           <label class="control-label">Contraseña *</label>
           <input class="form-control" type="password" name="txt_password" required="" maxlength="70">
        </div>
          </div>
          <div class="col-xs-12 col-sm-6">
        <div class="form-group label-floating">
           <label class="control-label">Repita la contraseña *</label>
           <input class="form-control" type="password" name="txt_password_retype" required="" maxlength="70">
        </div>
          </div>
          <div class="col-xs-12 col-sm-6">
        <div class="form-group label-floating">
           <label class="control-label">E-mail</label>
           <input class="form-control" type="email" name="txt_email" maxlength="50">
        </div>
          </div>
          <div class="col-xs-12">
        <div class="form-group">
         ...
         <div class="radio radio-primary">
          <label>
           <input type="radio" name="optGenero" id="optionsRadios1" value="Masculino" checked="">
           <i class="zmdi zmdi-male-alt"></i> &nbsp; Masculino
          </label>
         </div>
         <div class="radio radio-primary">
          <label>
           <input type="radio" name="optGenero" id="optionsRadios2" value="Femenino">
